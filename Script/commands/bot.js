...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "বিয়া করেন") || (event.body.toLowerCase() == "biya koren") || (event.body.toLowerCase() == "Biya koren") || (event.body.toLowerCase() == "Biya Koren") || (event.body.toLowerCase() == "মাসনা করেন") || (event.body.toLowerCase() == "masna koren")) {
