...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "বিয়া করেন") || (event.body.toLowerCase() == "biya koren")) {
     return api.sendMessage("অন্যের বিয়ের চিন্তা না করে আগে নিজে একটা মেয়ে খুঁজে বিয়ে করো আর যদি বিবাহিত হও তাহলে লিখো আমি বিবাহিত", threadID);
   };
   
   if ((event.body.toLowerCase() == "আমি বিবাহিত") || (event.body.toLowerCase() == "ami bibahito")) {
     return api.sendMessage("বিয়ের দাওয়াত তো দিলেন না আবার বলেন আমি বিয়াইত্তা😒\nতাড়াতাড়ি মাসনার জন্য পাত্রী দেখেন এবং আমাদের দাওয়াত দেন আর আপনার শালীঠালী থাকলে আমার উস্তাদদের জন্য বিয়ের ব্যবস্থা করেন", threadID);
   };

    if ((event.body.toLowerCase() == "😘") || (event.body.toLowerCase() == "😽")) {
     return api.sendMessage("আমাদের গ্রুপে এই কিস ঠিস না দিয়ে আপনার আহলিয়ার মেসেঞ্জারে পাঠান \nআর যারা আমার মত সিঙ্গেল তারা fake I'd খুলে তারপর কিস emoji send করেন", threadID);
   };
